    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                {{ Form::open(['action' => 'UserController@store','class' => 'form-horizontal']) }}
                    ...
                    <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                        {{Form::label('password_confirmation', trans('user.password_confirmation'), ['class' => 'col-sm-2 control-label'])}}
                        <div class="col-sm-10">
                    ...
                    <div class="form-group {{ $errors->has('department_id') ? 'has-error' : '' }}">
                        {{Form::label('department_id', trans('user.department'), ['class' => 'col-sm-2 control-label'])}}
                        <div class="col-sm-10">
            ...
            <div class="box-footer">
                    {{Form::submit(trans('user.create'), ['class' => 'btn btn-primary col-sm-offset-2'])}}
                    <a href={{action('Auth\RegisterController@register')}} class="btn btn-primary">{{ trans('user.create_continue') }}</a>
            </div>
                {{ Form::close() }}
            </div>
        </div>
